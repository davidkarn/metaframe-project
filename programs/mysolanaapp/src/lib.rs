...
mod mysolanaapp {
    ...
    pub fn post_comment(ctx: Context<PostComment>, username: String, message: String, site: String, path: String, node_hash: String, selection: String) -> ProgramResult {
        ...
        comment.site        = Pubkey::new(site.as_bytes());
        comment.path        = Pubkey::new(path.as_bytes());
        comment.node_hash   = Pubkey::new(node_hash.as_bytes());
...
const MAX_MESSAGE_LENGTH:   usize = 2048 * 4; // 1024 chars max.
